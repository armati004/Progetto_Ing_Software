...
/**
 * Classe che rappresenta i dati salvati di una partita
 * Include solo le informazioni essenziali per ripristinare lo stato
 */
public class GameSaveData {
     ...
     */
    public GameSaveData(int annoCorrente, int numeroGiocatori, List<PlayerSaveData> giocatori,
                        int giocatoreCorrente, boolean vittoriaUltimaPartita, String nomePartita) {
